...
import forPage3 from '../Assets/border/forPage3.png'
const Page3 = () => {
    ...
    return (
        <>
            {zoom ? (<>
                <div className='text-center relative h-full bg-white flex flex-col justify-center text-[#808080] '>
                    <div className='flex justify-center pb-4'>
                        <img src={forPage3} className=" w-[30rem] md:w-64 pt-11 z-10 mx-auto" />
                    </div>
            ...
            font-bold px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-2/5" onClick={() => { setZoom(false) }}>false</button> */}
                    ...
                    <CarouselProvider className='relative h-full md:top-0 '
                        naturalSlideWidth={100}
                        // window.innerWidth < 880 ? 175 : 40
                        naturalSlideHeight={window.innerWidth < 880 ? 175 : 35}
                        totalSlides={3}>
                        <h5 className='md:absolute md:w-full md:top-10 relative font-alexBrush text-5xl sm:text-3xl font-extrabold text-[#808080]'>
                            Galeri
                        </h5>
                        <Slider className='h-full px-2 ' onClick={() => { setZoom(false) }}>
                            <Slide index={0}><img className='shadow-slate-500 shadow-xl rounded-full border-[#817289] border-y-4' src={imgGalleery1}></img></Slide>
                            <Slide index={1}><img className='shadow-slate-500 shadow-xl rounded-full border-[#817289] border-y-4' src={imgGalleery2}></img></Slide>
                            <Slide index={2}><img className='shadow-slate-500 shadow-xl rounded-full border-[#817289] border-y-4' src={imgGalleery3}></img></Slide>
                        </Slider>
                        <div className='flex flex-row absolute w-1/2 justify-between px-4 left-1/4 md:left-0 md:w-full top-[45%] text-white'>
                ...
                <div className='flex justify-center'>
                    <img src={forPage3} className='absolute w-[30rem] md:w-64 bottom-10 mt-5 z-10 rotate-180' />
                </div>
            </>
                ...
                <div className='fixed w-[102vw] h-[104vh] -left-[5.6%] -top-[14%] z-30'>
            ...
            font-bold px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-2/5" onClick={() => { setZoom(true) }}></button> */}
                    ...
                    <button className="bg-blue-200 text-black active:bg-blue-500 
            font-bold fixed rounded shadow hover:shadow-lg outline-none focus:outline-none left-[93%] -top-10 z-30" onClick={() => { setZoom(true) }}><AiOutlineCloseCircle size={'3rem'} /></button>
                </div>
