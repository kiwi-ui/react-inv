...
const Page2 = () => {
    ...
    return (
        <>
            <div className='relative w-full h-full  bg-white font-Poppins text-[#808080]'>
                ...
                <div className='relative flex flex-col  bg-white justify-center items-center gap-5 pb-24'>
